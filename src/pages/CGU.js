...
function Cgu() {
  return (
    <div className={"mainCGU"}>
      ...
      <p className={"pCGU"}>
        Conditions générales d'utilisation En vigueur au 07/04/2025 Les
        présentes conditions générales d'utilisation (dites « CGU ») ont pour
        objet l'encadrement juridique des modalités de mise à disposition du
        site et des services par Sacha Allardin et de définir les conditions
      ...
      <p className={"pCGU"}>
        ...
        est assurée par Allardin Sacha, domicilié 21 Rue des hautes granges,
        Blois.
      </p>
      <p className={"pCGU"}>
        Numéro de téléphone :{" "}
        <a href="tel:+33.7.60.42.40.05"> 07.60.42.40.05</a>
      </p>
      <p className={"pCGU"}>
        Adresse e-mail :{" "}
        <a href="mailto:sacha.allardin06@gmail.com">
          {" "}
          sacha.allardin06@gmail.com
        </a>
        .
      </p>
      <p className={"pCGU"}>
        ...
        est la société Plesk, dont le siège social est situé au …, avec le
        numéro de téléphone : ….
      </p>
      ...
      <p className={"pCGU"}>
        ...
        permet à l'Utilisateur un accès gratuit aux services suivants : Le site
        internet propose les services suivants :
      </p>
      <p className={"pCGU"}>Vente en ligne produits liés au café et au thé</p>
      <p className={"pCGU"}>
      ...
      <p className={"pCGU"}>
        Le site permet aux membres de publier les contenus suivants : Revues et
